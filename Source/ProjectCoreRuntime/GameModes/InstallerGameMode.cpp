...
void AInstallerGameMode::InitializeScope(UConfigs* Configs, TSubclassOf<UInstallerScope> ScopeClass)
{
	...
	{
		auto InstallerScope = NewObject<UInstallerScope>(this, ScopeClass);
